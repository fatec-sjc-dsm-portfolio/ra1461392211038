document.addEventListener('DOMContentLoaded', () => {
  const projects = [
    { id: 1, title: 'API do Primeiro Semestre Service Desk - (2022)', description: 'Em modo geral, uma Central de Serviços é uma ferramenta que presta assessoria para solucionar problemas integrado no ambiente de tecnologia da informação. Este projeto será realizado baseado na metodologia ágil SCRUM, que foca no desenvolvimento da proatividade, autonomia e uma melhora da produtividade do time como um todo. Foram utilizadas algumas das seguintes tecnologias: HTML, CSS, JavaScript, Python, Flask e MySQL.' },
  ...
  const model = [
    { id: 1, title: 'Service Desk - (2022)', description: 'Participei nesse projeto colaborando com parte do desenvolvimento do frontend das páginas, além de criar o backend e lógica de rotas para a comunicação front do com back. Como primeiro projeto utilizando Flask e Javascript, houve momentos desafiadores visto que na epoca não existia ferramentas de auxilio como ChatGPT. Entretanto consegui desenvolver minha parte junto de minha equipe, fazendo assim meu primeiro projeto web mais robusto no qual aprendi muitas coisas que levo até hoje.' , image: 'assets/img/1api.png' },
