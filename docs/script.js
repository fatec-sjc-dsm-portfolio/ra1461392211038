document.addEventListener('DOMContentLoaded', () => {
  const projects = [
    { id: 1, title: 'Service Desk - (2022)', description: 'Service DeskNesse projeto, o objetivo era desenvolver uma central de ajuda com assuntos relacionados à tecnologia. Foram utilizadas algumas das seguintes tecnologias: HTML, CSS, JavaScript, Python, Flask e MySQL.' },
  ...
  const model = [
    { id: 1, title: 'Service Desk - (2022)', description: 'Participei nesse projeto colaborando com parte do desenvolvimento do frontend das páginas, além de criar o backend e lógica de rotas para a comunicação front do com back.' , image: 'assets/img/1api.png' },
